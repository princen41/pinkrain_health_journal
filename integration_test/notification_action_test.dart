...
void main() {
  ...
  group('Notification Action Tests', () {
    ...
    testWidgets('Test notification creation with action buttons',
      ...
      final NotificationResponse takenResponse = NotificationResponse(
        ...
        payload:
            '{"medicationId":"$testMedicationId","notificationId":"$notificationId","medicationName":"Test Medication"}',
      ...
      final isTaken =
          await medicationActionService.isMedicationTaken(testMedicationId);
      ...
      final statusMap =
          await medicationActionService.getMedicationStatus(testMedicationId);
      expect(statusMap['status'], 'snoozed',
          reason: 'Medication should be marked as snoozed');
      expect(statusMap.containsKey('snoozeUntil'), true,
          reason: 'Snooze until time should be set');
